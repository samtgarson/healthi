function dragStop() {
    var ease = "easeOutExpo", time = 700, navArray = [ 0, -79, -158, -237 ], navTarget = parseInt($(".selector ul").css("marginLeft")), navResult = nearest(navTarget, navArray), navMargin = $("body").width() / 2 + navResult, pageArray = [ 0, -100, -200, -300 ], pageTarget = parseInt($(".slider-content").css("left")) / $(".slider-content").width(), pageResult = nearest(400 * pageTarget, pageArray), pageMargin = pageResult + "%";
    return $(".selector ul").animate({
        marginLeft: navResult
    }, time, ease), $(".slider-nav ul").animate({
        left: navMargin
    }, time, ease), $(".slider-content").animate({
        left: pageMargin
    }, time, ease), !1;
}
...
function pageDragDuring() {
    ...
    console.log(dragPercent), $(".slider-nav ul").css("left", navMargin), $(".selector ul").css("marginLeft", selectMargin - 2);
}
...
function slideAll(index) {
    ...
    console.log(), $(".slider-content").animate({
        left: "-" + pageMargin + "%"
