function dragStop() {
    var a = [ 0, -79, -158, -237 ], n = parseInt($(".selector ul").css("marginLeft")), r = nearest(n, a), m = $("body").width() / 2 + r, e = "easeOutExpo", time = 700;
...
function slideNav(index) {
    var r = -79 * index, m = $("body").width() / 2 + r, e = "easeOutExpo", time = 700;
    $(".selector ul").animate({
        marginLeft: r
    }, time, e), $(".slider-nav ul").animate({
        left: m
