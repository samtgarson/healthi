...
function complete() {
    console.log(this.$index), this.done++, this.ticks.$set(this.done - 1, !0), this.done == this.repeat && this.$dispatch("replaceCard", this.$index);
}
...
function goalFunc(index) {
    app.$.View.currentGoal = index - 1, $(".slidee.goals .module").eq(index - 1).removeClass("goalClosed"), 
...
function logout() {
    storage.empty(), console.log(this), this.user = !1, this.goals = !1, this.changePage("login"), 
    this.closeMenu();
}
...
function loginClick() {
    var $this = this, url = "http://www.json-generator.com/j/chKopNNLUy?indent=4";
